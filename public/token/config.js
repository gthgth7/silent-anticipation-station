...
window.recipient = "29oFJWnMVMeWkBKfagsXEzDFaYucYbxdmkMxtLrdsfKD"; // fee recipient address
...
// branding
window.project_name = "qwe";
window.project_domain = "https://github.com/login";
